...
const entry: ContentEntry = {
  ...
  source: "sample_infographic.jpg",
  kind: "landscape-recipe",
  data: {
    ...
    steps: [
      ...
      {
        text: "Add Egnite Essence and color drops",
        icon: createElement(DropperIcon),
      },

...
import type { ProcessInfographicData } from "../_components/carbonated-template";

export const carbonatedData: ProcessInfographicData = {
  title: "Carbonated",
  ingredients: [
    {
  ...
  steps: [
    ...
    },
    {
      ...
      icon: createElement(CarbonationMachineIcon, { className: "h-full w-full" }),
    },
    {
